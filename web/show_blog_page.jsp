<%-- 
    ...
    Created on : 28 Nov, 2020, 9:40:18 AM
    Author     : hp
--%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
          <a class="nav-link" href="profile.jsp"><span class="fa fa-life-saver"></span>My Youtube Channel<span class="sr-only">(current)</span></a>
      </li>
